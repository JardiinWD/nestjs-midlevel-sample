...
export class FilesService extends TypeOrmCrudService<FileEntity> {
     ...
     */
    async saveFileOnDatabase(file: Express.Multer.File, newFileName: string): Promise<FileEntity> {
     ...
     */
    private mapUploadFile({ originalname, mimetype, size }: Express.Multer.File, newFileName: string): Partial<FileEntity> {
